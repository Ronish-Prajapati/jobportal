...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© Do like and Subscribe</p>
</div>
</footer> 
...
$('#profilePicForm').submit(function(e){
    e.preventDefault();
    var formData = new FormData(this); // Fixed typo
    $.ajax({
        url: '{{ route("account.updateProfilePic") }}', // Ensure correct route
        type: 'POST', // Correct method is POST
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
