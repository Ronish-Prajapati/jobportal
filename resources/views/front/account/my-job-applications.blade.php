                                        ...
                                        @if ($jobApplications->isNotEmpty())
                                            @foreach ($jobApplications as $jobApplication)
                                                    ...
                                                    <tr class="active">
                                                        ...
                                                        <td>{{\Carbon\Carbon::parse($jobApplication->appliedDate)->format('d M,Y')}}</td>
                                                        ...
                                                        <td>
                                                            <div class="action-dots float-end">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="#" onclick="removeJob({{$jobApplication->id}})"><i
            ...
            $.ajax({
                ...
                success: function(response){
                    if (response.status) {
                        ...
                        alert('Failed to remove the job application.');
                    }
                },
                error: function(xhr, status, error) {
                    alert('Error: ' + xhr.responseText); // For debugging
                }
            });
        }
    }
