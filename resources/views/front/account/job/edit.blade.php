                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <input type="number" value="{{$job->vacancy}}" min="1" placeholder="Vacancy" id="vacancy" name="vacancy"
                                        class="form-control">
                                        <p></p>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" placeholder="Salary" id="salary" name="salary" value="{{$job->salary}}"
                                        class="form-control">
                                </div>
...
@section('customJs')
    <script>
        $('#editJobForm').submit(function(e) {
            ...
            $.ajax({
                url: '{{ route('account.updateJob',$job->id) }}', // Use correct route
                type: 'POST', // Correct method for update
                dataType: 'json',
                data: $('#editJobForm').serializeArray(), // Correct form ID and serialize dataf
